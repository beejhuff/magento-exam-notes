...
Module_One and Module_Two both depend on Mage_Core. Both of these modules include this dependency in their registration XML file.
...
### 3.3 An Alternate Solution

It is worth mentioning that it is preferable to use an Observer to append some functionality to core Magento behaviour as most events that take place in Magento can be listened for by an Observer. This saves any core functionality from being editted too heavily which can, for example, make upgrading Magento and applying patches difficult and create difficulties like the above.
...
https://www.mconnectmedia.com/blog/ways-to-identify-and-resolve-magento-extension-conflicts/
