...
This aims to answer how a database connection is configured and also how this is used in Magento with collections.
...
Database credentials are set in *app/etc/local.xml*
...
Let's break down this XML and take a look at the values in some of the nodes.

**default_setup**
This is merged with the local.xml in *Mage_Core_Model_App->baseInit()* and contains your database credentials.
...
Database configuration is set in local.xml
Database core connection is set in config.xml (so it won't be overridden)
